...
namespace CommonLib.Config
{
    ...
    {
        public static void LoadConfig<T>(ICoreAPI api, ref T config, ILogger logger) where T : class
        {
            config = (T)LoadConfig(api, typeof(T), config, logger);
        }

        public static object LoadConfig(ICoreAPI api, Type type, object config, ILogger logger)
        {
            logger ??= api.Logger;
